...
export const journeys: Journey[] = [
  ...
  },
  {
    ...
    habits: ['No screens before bed', 'Prepare tomorrow', 'Sleep before 11 PM'],
  ...
  },
  {
    ...
    habits: ['Drink water', 'Move for 5 minutes', 'Choose today’s priority'],
